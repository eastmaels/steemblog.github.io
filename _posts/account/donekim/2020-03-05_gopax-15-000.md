...
---
title: '[GOPAX] 고팍스 거래소 가입하고 15,000원 받아가세요!'
...
체험단의 경우 VIP회원과 동일한 리워드 혜택을 얻게되는 관계로, 저는 일단 **제가 받게 되는 리워드까지 모두 보내드릴까**합니다.

#### 즉, 제 레퍼럴 링크로 고팍스에 신규 가입을 하시게 되면 5,000원 + 10,000원 = 총 15,000원을 받으실 수 있습니다.
...
**(1) 일단 계좌 등록이 완료된 시간을 기억해주세요.**(예시 : 3월 6일 오후 11시 32분)

**(2) 제 [카카오톡 오픈채팅방](https://open.kakao.com/o/sfOFcstb)으로 메시지를 남겨주세요**

**(3) 5,000원은 회원가입하신 고팍스의 계좌로 바로 입금이 되고, 10,000원은 카카오톡에 남겨주신 계좌로 바로 계좌이체를 해드립니다**


지금 이런 가입이벤트는 코박에서 7,000원 입금해주는 게 최고 수준인 것으로 알고 있습니다. 일단은 제 스티밋 블로그를 봐주신 분들만을 대상으로 이렇게 진행을 하려고 하고, 추후에는 리뷰헌트를 이용해서 리워드를 조금 낮춰서 진행해볼 예정입니다.

#### 혹시라도 아직 고팍스 계정이 없으신 분들은 지금 가입하시고 15,000원 받아가세요!!

- - -

This page is synchronized from the post: ['[GOPAX] 고팍스 거래소 가입하고 15,000원 받아가세요!'](https://steemit.com/@donekim/gopax-15-000)
