...
---
title: 'Simple Video Downloader 3.0.8 - Adding SSP Video Parser (Reverse Engineering), Refactoring and Live Tested URL.'
permlink: simple-video-downloader-3-0-8-adding-ssp-video-parser-reverse-engineering-refactoring-and-live-tested-url
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2018-12-09 19:30:42
categories:
- utopian-io
tags:
- utopian-io
...
![image.png](https://ipfs.busy.org/ipfs/QmPZia9P2P7FWb3csEzVN2gCEiLArWfK3us8SJHqvrYYC7)
...
# Changes v3.0.8
Pull Requests Merged: https://github.com/DoctorLai/VideoDownloadHelper/pull/8

1. use live github url for showing tested URLs.
2. add SSP video parser and unit tests. Some video sites are hiding their true video URLs and it takes a while to do some reverse engineering and find out how to get the real videos.
3. refactoring.
...
59 tests passed on Travis CI: https://travis-ci.com/DoctorLai/VideoDownloadHelper/builds/94123447
...
This page is synchronized from the post: ['Simple Video Downloader 3.0.8 - Adding SSP Video Parser (Reverse Engineering), Refactoring and Live Tested URL.'](https://steemit.com/@justyy/simple-video-downloader-3-0-8-adding-ssp-video-parser-reverse-engineering-refactoring-and-live-tested-url)
