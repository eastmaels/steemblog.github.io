...
---
title: 'Witness Update: Node Upgraded to 0.20.8!'
permlink: witness-update-node-upgraded-to-0-20-8
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2018-12-15 15:11:51
categories:
- witness-category
tags:
- witness-category
...
# @justyy's Witness Nodes have been smoothly upgraded to 0.20.8 without any downtime - via the docker command `./run.sh install && ./run.sh restart`

Upagrading from 0.20.7 to 0.20.8 is optional but recommended as this update fixes a memory-leak problem. And most importantly, it does not require a replay (re-indexing takes ages, as every steem witness knows).

![](https://thumbs.gfycat.com/ScentedSpotlessCormorant-small.gif)
...
79 blocks (↓3) produced in last 7 days and rewarded 175728.9510 VESTS in total (approximately 87.0807 Steem Power).

## Witness Summary
Rank 65 ( ↓ 1 place) - Total Votes: 12322 MVs  ↑ and 704 Voters ↑. Total: Missed 25 Blocks. (0 - Miss this week). Feed published every 2 hours smoothly.
