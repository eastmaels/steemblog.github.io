...
---
title: 'Update: VPS Database and Search Tool with Sorting and Pagination'
permlink: update-vps-database-and-search-tool-with-sorting-and-pagination
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2018-10-18 19:17:39
categories:
- busy
tags:
- busy
...
## New Features
Now [VPS Database and Search Tool](https://anothervps.com/vps-database/) supports Sorting and the Pagination.

![image.png](https://ipfs.busy.org/ipfs/QmTdVYDSrytUUqoRoQUbigf7Q9Qxa1FzAiARXGLMEQkKCL)

# RoadMap
Adding more VPS plans....
