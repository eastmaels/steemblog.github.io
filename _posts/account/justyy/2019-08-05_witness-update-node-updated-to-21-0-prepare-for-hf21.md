...
---
title: 'Witness Update: Node updated to 21.0 - prepare for HF21!'
permlink: witness-update-node-updated-to-21-0-prepare-for-hf21
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2019-08-05 20:45:03
categories:
- busy
tags:
- busy
...
- spt
- whalepower
thumbnail: 'https://media.giphy.com/media/4Tkagznwgrv6A4asQb/giphy.gif'
sidebar:
    right:
        sticky: true
widgets:
...
Happy to see that I am on version 21 - currently, replaying the backup witness node as well.
...
0. [One Year Witnessversary - A Great Start!](https://staging.busy.org/@justyy/one-year-winessversary-a-great-start)
...
This page is synchronized from the post: ['Witness Update: Node updated to 21.0 - prepare for HF21!'](https://steemit.com/@justyy/witness-update-node-updated-to-21-0-prepare-for-hf21)
