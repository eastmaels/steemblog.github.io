...
---
title: 'Received the Gift from Digital Ocean - The Hacktoberfest T-shirt and Gadgets'
permlink: received-the-gift-from-digital-ocean-the-hacktoberfest-t-shirt-and-gadgets
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2019-01-10 20:05:12
categories:
- busy
tags:
- busy
...
3 Months ago, I completed the Hacktoberfest challenge - which is completing 5 pull requests

See [this post](https://steemit.com/busy/@justyy/justyy-has-completed-the-hacktoberfest-challenge)

![](https://steemitimages.com/640x0/https://ipfs.busy.org/ipfs/QmVw6PL18gqexdECfahXQTP2ZfXhRVyBNensQuq3mViGmK)

Finally, received the gifts today... 

![image.png](https://ipfs.busy.org/ipfs/QmTo7KJ348DowNfnq3U6vWsE8cNbufpGwJ6uZfreJ4C19X)

Love the gadgets! especially the Github sticker!
![image.png](https://ipfs.busy.org/ipfs/QmVDMYCndSAmfkjaEdi1K2EkXQC4WMVzDA5kek7TeMzTts)

// [参加 2018 Hacktoberfest 活动，收到一件衣服和几个小玩意](https://justyy.com/archives/6816)
...
![image.png](https://ipfs.busy.org/ipfs/QmTmThoqVzPEys1jsL65YccdoQBCCPmigJTSCmwHHTRi6W)
