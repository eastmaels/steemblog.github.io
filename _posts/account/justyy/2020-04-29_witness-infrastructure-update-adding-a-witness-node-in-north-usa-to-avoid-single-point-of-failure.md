...
---
title: 'Witness Infrastructure Update: Adding a Witness Node in North USA to Avoid Single-Point-of-Failure'
permlink: witness-infrastructure-update-adding-a-witness-node-in-north-usa-to-avoid-single-point-of-failure
catalog: true
toc_nav_num: true
toc: true
position: 9999
...
- whalepower
- servers
thumbnail: 'https://cdn.steemitimages.com/DQmdkVRvdL1zS56Lhavy3xAxqqGuver8wCpvCGSCM46rBAK/image.png'
sidebar:
    right:
        sticky: true
widgets:
...
![image.png](https://cdn.steemitimages.com/DQmdkVRvdL1zS56Lhavy3xAxqqGuver8wCpvCGSCM46rBAK/image.png)
...
PS: I got the dedicated server from [Dacentec](https://justyy.com/out/da).
...
This page is synchronized from the post: ['Witness Infrastructure Update: Adding a Witness Node in North USA to Avoid Single-Point-of-Failure'](https://steemit.com/@justyy/witness-infrastructure-update-adding-a-witness-node-in-north-usa-to-avoid-single-point-of-failure)
