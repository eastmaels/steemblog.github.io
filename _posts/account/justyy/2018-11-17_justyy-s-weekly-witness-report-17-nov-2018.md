...
---
title: '@justyy ''s Weekly Witness Report - 17/Nov/2018'
permlink: justyy-s-weekly-witness-report-17-nov-2018
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2018-11-17 19:13:24
categories:
- witness-category
tags:
- witness-category
...
# Last Report
[@justyy 's Weekly Witness Report - 11/Nov/2018](https://steemit.com/witness-category/@justyy/justyy-s-weekly-witness-report-11-nov-2018)
...
83 blocks produced in last 7 days and rewarded 175454.6441 VESTS in total (approximately 86.9448 Steem Power).

## Witness Summary
58 - Dropped 3 positions - 12080 MV and 675 Voters. Total: Missed 25 Blocks. (0 - Miss this week). Feed published every 2 hours smoothly.

## Delegation
@justyy is the 7-th most delegated project on steem blockchain (See below).

# Utopian Moderations
1. [yDiceBot v4.0.0 is released - PrimeDice is supported NOW! Earn BTC/BCH/ETH/LTC/DOGE quickly!](https://steemit.com/utopian-io/@justyy/re-mydicebot-mydicebot-v4-0-0-is-released-primedice-is-supported-now-earn-btc-bch-eth-ltc-doge-quickly-20181116t142423990z)

# API Severs
All API Servers have been upgraded to Ubuntu 18.04. 

# Development Posts
1. [Simple Video Downloader 3.0.5 - Supporting MSDN and TED !](https://steemit.com/utopian-io/@justyy/simple-video-downloader-3-0-5-supporting-msdn-and-ted)
2. [Simple Video Downloader 3.0.4 - Webpack, ES6, Unit Tests and more!](https://steemit.com/utopian-io/@justyy/simple-video-downloader-3-0-4-webpack-es6-unit-tests-and-more)

# Blog posts
1. [How to Determine the Type of Tree Nodes using SQL?](https://helloacm.com/how-to-determine-the-type-of-tree-nodes-using-sql/)
2. [The Array Unique Function in Javascript – Remove Duplicates in Javascript Array](https://helloacm.com/the-array-unique-function-in-javascript-remove-duplicates-in-javascript-array/)

# Others
Apart from STEEM price going down (but I still have faith for STEEM), Not so much ongoing this week and looking forward to the new job in Two weeks!
...
![image.png](https://ipfs.busy.org/ipfs/QmQLqWJ7eww4NYRaWzpv7MHWWhT2MZz59MM9v5XoynqWTy)
...
This page is synchronized from the post: [@justyy ''s Weekly Witness Report - 17/Nov/2018](https://steemit.com/@justyy/justyy-s-weekly-witness-report-17-nov-2018)
