...
---
title: 'Simple Video Downloader 3.0.6 - Supporting Weibo and XiaoKaXiu'
permlink: simple-video-downloader-3-0-6-supporting-weibo-and-xiaokaxiu
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2018-11-20 00:41:09
categories:
- utopian-io
tags:
- utopian-io
...
![image.png](https://ipfs.busy.org/ipfs/QmS5xjWkc6sCwXuq6REoYUTxgv29CCzBqPR3ChuFLQThEV)
...
# Changes v3.0.6
Pull Requests Merged: https://github.com/DoctorLai/VideoDownloadHelper/pull/6

1. Add Xiaokaxiu Parser and Unit Tests
2. Add Weibo Parser and Unit Tests
3. Refactor: let => const
4. Improve Array.Uniq

# Unit Tests
`npm run test`
![image.png](https://ipfs.busy.org/ipfs/QmNRALtBNUk2vyyTgkL6S4ZGMbdogFD3F7bv3MPJfTwL8r)

# Build
`npm run build` which webpacks the ES6 class `ParseVideo` into `\dist\*js`

# Screenshot
![image.png](https://ipfs.busy.org/ipfs/Qmb2heQ4Po8G4rwPe2ScibuE4hUu8omj2zD4xy8avrWy97)
...
This page is synchronized from the post: [Simple Video Downloader 3.0.6 - Supporting Weibo and XiaoKaXiu](https://steemit.com/@justyy/simple-video-downloader-3-0-6-supporting-weibo-and-xiaokaxiu)
