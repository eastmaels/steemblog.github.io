...
---
title: '@justyy ''s Weekly Witness Report - 06/Januray/2019'
permlink: justyy-s-weekly-witness-report-06-januray-2019
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2019-01-06 22:22:09
categories:
- witness-category
tags:
- witness-category
...
# Last Report
[@justyy 's Weekly Witness Report - 31/Dec/2018](https://steemit.com/witness-category/@justyy/justyy-s-weekly-witness-report-31-december-2018)
...
80 blocks (↑3) produced in last 7 days and rewarded 179878.2940 VESTS in total (approximately 89.1369 Steem Power).

## Witness Summary
Rank 65 ( ↑ 1 place) - Total Votes: 12518 MVs ↑  and 713 Voters↓ . Total: Missed 26 Blocks. (0 - Miss this week). Feed published every 2 hours smoothly.

## Delegation
@justyy is the 7-th most delegated ([292 Delegators  ↑](https://steemyy.com/delegators/?id=justyy)) project on steem blockchain (See below).
...
# Utopian Moderations
1. [RE: Steem Voice A0.5 - Migration to Google V2 API](https://steemit.com/utopian-io/@justyy/re-fancybrothers-steem-voice-a0-5-migration-to-google-v2-api-20190105t121827784z)
2. [RE: Update for Steem Basic Income Automation - get_blog and comment_history replaced and comment upvoting ](https://steemit.com/utopian-io/@justyy/re-holger80-update-for-steem-basic-income-automation-getblog-and-commenthistory-replaced-and-comment-upvoting-enabled-20181231t094039724z)
...
# Blog posts
1. [Using Parallel For in Java to Compute PI using Monte Carlo Algorithm](https://helloacm.com/using-parallel-for-in-java-to-compute-pi-using-monte-carlo-algorithm/)
2. [3 Types of Coding Languages That Will Intrigue & Educate Youngsters](https://helloacm.com/3-types-of-coding-languages-that-will-intrigue-educate-youngsters/)
3. [CleanTalk Review – The Best Paid Cloud Anti-Spam/Security Plugins for WordPress (Akismet Alternative)](https://helloacm.com/cleantalk-review-the-best-paid-cloud-anti-spam-security-plugins-for-wordpress-akismet-alternative/)
3. [The Jumping Kangaroo Problem (Dynamic Programming + Greedy Algorithm)](https://helloacm.com/the-jumping-kangaroo-problem-dynamic-programming-greedy-algorithm/)
4. [The Benefits Coders Can Expect In The Future](https://codingforspeed.com/the-benefits-coders-can-expect-in-the-future/)

# Chinese Posts 中文
1. [SteemIt 终于升到 72级](https://justyy.com/archives/6811)
...
![image.png](https://ipfs.busy.org/ipfs/Qmbi7t1tHCDEBxnKhtcaKEaE7TbFjLdGq63bKHbtpdsF5c)
