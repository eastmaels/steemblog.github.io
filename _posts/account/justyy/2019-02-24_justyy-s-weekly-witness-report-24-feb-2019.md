...
---
title: '@justyy''s Weekly Witness Report - 24/Feb/2019'
permlink: justyy-s-weekly-witness-report-24-feb-2019
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2019-02-24 20:19:33
categories:
- witness-category
tags:
- witness-category
...
> I am currently the [7-th most delegated account - currently 303 delegators!](https://steemyy.com/top-delegations-by-count/) on the STEEM Blockchain.
...
# Last Report
[@justyy's Weekly Witness Report - 17/Feb/2019](https://steemit.com/witness-category/@justyy/justyy-s-weekly-witness-report-17-feb-2019)
...
71 blocks (+1) produced in last 7 days and rewarded 161697.0621 VESTS in total (approximately 80.1273 (+1) Steem Power).

## Witness Summary
Rank 73(-1) - Total Votes: 12006MVs (around -180 MVs)  and 761 Voters (+4) . Total: Missed 28 Blocks. (0 - Miss this week). Feed published every 2 hours smoothly.
...
## Delegation
@justyy is the 7-th most delegated ([303 Delegators](https://steemyy.com/delegators/?id=justyy)) project on steem blockchain (See below).
...
# Utopian Moderations
1. [RE: Utopian Task Completion: Steem Editor](https://steemit.com/utopian-io/@justyy/re-beggars-utopian-task-completion-steem-editor-20190223t150911954z)
2. [RE: Stratos Communities Database Upgrade - Utopian.io](https://steemit.com/utopian-io/@justyy/re-shredz7-stratos-communities-database-upgrade-utopian-io-20190218t203742135z)
3. [RE: Steem Node Exchange Tool - A chrome extension for saving steemian in China](https://steemit.com/cn/@justyy/re-liuzhixiang-steem-node-exchange-tool-a-chrome-extend-for-saving-steemian-in-china-20190217t152825717z)

# Steem Posts
1. [Steem Wallet Tool Upgrade - You can Specify counter and interval!](https://steemit.com/witness-category/@justyy/steem-wallet-tool-upgrade-you-can-specify-counter-and-interval)

# Blog posts
1. [How to Free TCP/UDP Port on Windows Using netstat and taskkill?](https://helloacm.com/how-to-free-tcp-udp-port-on-windows-using-netstat-and-taskkill/)
2. [The Cousins in Binary Tree](https://helloacm.com/the-cousins-in-binary-tree/)

# Chinese Posts
1. [在WINDOWS下如何释放被占用的TCP/UDP端口?](https://justyy.com/archives/6874)
...
![image.png](https://ipfs.busy.org/ipfs/QmZZgFfrJnzfLFNFgJeGNE1xfc9uSHDE3kaQjW3aN4uSZD)
...
This page is synchronized from the post: [@justyy''s Weekly Witness Report - 24/Feb/2019](https://steemit.com/@justyy/justyy-s-weekly-witness-report-24-feb-2019)
