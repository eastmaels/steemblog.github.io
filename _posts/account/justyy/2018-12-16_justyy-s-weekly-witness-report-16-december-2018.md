...
---
title: '@justyy ''s Weekly Witness Report - 16/December/2018'
permlink: justyy-s-weekly-witness-report-16-december-2018
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2018-12-16 18:59:09
categories:
- witness-category
tags:
- witness-category
...
# Last Report
[@justyy 's Weekly Witness Report - 9/Dec/2018](https://steemit.com/witness-category/@justyy/justyy-s-weekly-witness-report-09-december-2018)
...
78 blocks (↓ 1) produced in last 7 days and rewarded 173522.5043 VESTS in total (approximately 85.9873 Steem Power).

## Witness Summary
Rank 65 ( ↓ 2 place) - Total Votes: 12338 MVs ↓  and 704 Voters ↑. Total: Missed 25 Blocks. (0 - Miss this week). Feed published every 2 hours smoothly.

## Witness Category
1. [Witness Update: Node Upgraded to 0.20.8!](https://steemit.com/witness-category/@justyy/witness-update-node-upgraded-to-0-20-8)
2. [Witness Update: Node Upgraded to 0.20.7!](https://steemit.com/witness-category/@justyy/witness-update-node-upgraded-to-0-20-7)

## Delegation
@justyy is the 7-th most delegated ([283Delegators  →](https://steemyy.com/delegators/?id=justyy)) project on steem blockchain (See below).
...
# Utopian Moderations
1. [RE: SteemPlus API Updates : Getting ready for Premium Features](https://steemit.com/utopian-io/@justyy/re-steem-plus-steemplus-api-updates--getting-ready-for-premium-features-20181216t162509711z)
2. [RE: Re-entendiendo la Administración del Estado en JavaScript al construir una biblioteca similar a Redux](https://steemit.com/utopian-io/@justyy/re-abdt-re-entendiendo-la-administracion-del-estado-en-javascript-al-construir-una-biblioteca-similar-a-redux-20181215t200521537z)
...
# Blog posts
1. [The DI (Decreasing/Increasing) String Match Algorithm](https://helloacm.com/the-di-decreasing-increasing-string-match-algorithm/)
2. [Pros and Cons of Having SEO for White Label Services](https://helloacm.com/pros-and-cons-of-having-seo-for-white-label-services/)
3. [The Javascript Function to Compare Version Number Strings](https://helloacm.com/the-javascript-function-to-compare-version-number-strings/)
4. [Finding Two Numbers of Given Sum in Binary Search Tree](https://helloacm.com/finding-two-numbers-of-given-sum-in-binary-search-tree/)

# Chinese Posts 中文
1. [在英国体验坐公交车上班](https://justyy.com/archives/6676)
...
![image.png](https://ipfs.busy.org/ipfs/QmRvbw7jkKAZfdgCg8wVYAemNjbBU19FbThS1ukbk15soS)
...
This page is synchronized from the post: [@justyy ''s Weekly Witness Report - 16/December/2018](https://steemit.com/@justyy/justyy-s-weekly-witness-report-16-december-2018)
