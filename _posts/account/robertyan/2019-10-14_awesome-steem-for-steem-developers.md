...
---
title: 'awesome-steem for Steem developers'
permlink: awesome-steem-for-steem-developers
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2019-10-14 14:07:39
categories:
- cn
tags:
- cn
...
- lassecash
- upfundme
thumbnail: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/GitHub_logo_2013_padded.svg/256px-GitHub_logo_2013_padded.svg.png'
sidebar:
    right:
        sticky: true
widgets:
...
You might know the [awesome](https://github.com/sindresorhus/awesome) projects on GitHub, such as [awesome-php](https://github.com/ziadoz/awesome-php) and [awesome-vue](https://github.com/vuejs/awesome-vue), which summarized the coolest projects and tools built by community for a specific technology. 

As one tiny step of the initiatives to improve the **developer experience** for Steem developers, especially for those who are new to Steem, we're creating this [awesome-steem](https://github.com/steem-driver/awesome-steem) project to summarize the helpful **development resources for Steem ecosystem**, including SDKs, tutorials, libraries, example projects with source code, devops, community, etc. to make the learning and building process easier. 

* repository: https://github.com/steem-driver/awesome-steem

<center>
![](https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/GitHub_logo_2013_padded.svg/256px-GitHub_logo_2013_padded.svg.png)
<sup>image from [Wikipedia -- GitHub](https://en.wikipedia.org/wiki/GitHub) | [Public Domain](https://commons.wikimedia.org/wiki/File:GitHub_logo_2013_padded.svg)</sup>
</center>
...
If you have anything in mind want to add into the [awesome-steem](https://github.com/steem-driver/awesome-steem) project, feel free to leave your comments in the post or submit pull request to the project. 

Below is a snapshot of the content which you can find from the [awesome-steem](https://github.com/steem-driver/awesome-steem) project. 
...
- [Awesome Steem](#awesome-steem-awesomehttpsgithubcomsindresorhusawesome)
...
This page is synchronized from the post: ['awesome-steem for Steem developers'](https://steemit.com/@robertyan/awesome-steem-for-steem-developers)
